...
During the process of synthesis it is possible to define time constraints for your design.
...
\begin{figure}[!b]
    ...
    \fbox{\parbox[c][5cm]{8cm}{\centering [MISSING IMAGE: pics/fpgap/radio.jpg]}}
...
Fig.~\ref{sdr} shows the basic schematic of our software-defined FM radio transmitter.
...
\begin{tikzpicture}[scale=0.7]
    ...
    \draw[thick] (0.3,-1.1) -- (0.7,-1.1);
    \draw[thick] (0.4,-1.2) -- (0.6,-1.2);
    
    % Simplified Antenna
    \draw[thick] (0.5,1) -- (0.5,2);
    \draw[thick] (0.5,2) -- (0.2,2.5);
    \draw[thick] (0.5,2) -- (0.8,2.5);
\end{tikzpicture}
